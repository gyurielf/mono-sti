		...
		<div class="flex">
			...
			<div class="socials ml-2">
				<a
					...
					href="https://github.com/gyurielf/mono-sti/blob/main/src/lib/components/examples/AdvancedPhoneInput.svelte"
					target="_blank"
					rel="noreferrer"
				>
					<svg
	...
	<div>
		<div class="flex">
			...
			<div class="socials ml-2">
				<a
					class="relative flex items-center text-gray-soft hover:text-gray-inverse border-0 rounded-md"
					href="https://github.com/gyurielf/mono-sti/blob/main/src/lib/components/examples/BasicPhoneInput.svelte"
					target="_blank"
					rel="noreferrer"
				>
					<svg
	...
	<div>
		<div class="flex">
			...
			<div class="socials ml-2">
				<a
					class="relative flex items-center text-gray-soft hover:text-gray-inverse border-0 rounded-md"
					href="https://github.com/gyurielf/mono-sti/blob/main/src/lib/components/examples/EventDrivenPhoneInput.svelte"
					target="_blank"
					rel="noreferrer"
				>
					<svg
