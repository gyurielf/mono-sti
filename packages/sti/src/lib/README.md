...
[![npm version](https://badge.fury.io/js/mono-sti.svg)](https://badge.fury.io/js/mono-sti)

# Svelte Tel Input

> Lightweight svelte tel/phone input standardizer.

<img src="https://raw.githubusercontent.com/gyurielf/mono-sti/main/static/demo.gif" width="600px" align="center">

🔥 Check it out live [here](https://mono-sti.vercel.app/)

## Installation

Svelte Tel Input is distributed via [npm](https://www.npmjs.com/package/mono-sti).

```bash
npm install --save mono-sti
```
...
_Snippet would be too long_ - [REPL](https://stackblitz.com/edit/mono-sti-repl-1jfaar?file=README.md) (StackBlitz)

### Basic

[REPL](https://stackblitz.com/edit/mono-sti-repl?file=README.md) (StackBlitz)

```html
<script lang="ts">
	import { TelInput, normalizedCountries } from 'mono-sti';
	import type { DetailedValue, CountryCode, E164Number } from 'mono-sti/types';
...
| Package                | Changelog                 |
| ---------------------- | ------------------------- |
| [@gyurielf/mono-sti]() | [Changelog](CHANGELOG.md) |
